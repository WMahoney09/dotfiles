...
local p = {
  ...
  -- Syntax (from VSCode Citadel tokenColors)
  comment = "#326d65",
  variable = "#fbcab7",
  keyword = "#ceaf76",
  string = "#e49358",

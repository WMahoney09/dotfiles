...
local p = {
  ...
  -- Syntax (from VSCode Grizzly tokenColors)
  comment = "#755648",
  variable = "#f3bc90",
  keyword = "#ceaf76",
  string = "#e67b34",

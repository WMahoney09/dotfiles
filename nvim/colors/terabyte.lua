-- Paddy Terabyte colorscheme
-- Ported from https://github.com/yl92/paddy-color-theme

vim.cmd("hi clear")
vim.g.colors_name = "terabyte"
...
local p = {
  ...
  -- Syntax (from VSCode Terabyte tokenColors)
  comment = "#3c5e48",
  variable = "#efc6a4",
  keyword = "#bebebe",
  string = "#dbae5f",
  ...
  tag = "#63c291",
  operator = "#b87e76",
  operator_logical = "#e0a03e",
  operator_comparison = "#76b66e",
  operator_assignment = "#8a5656",
